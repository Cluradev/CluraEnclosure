...
/* Upper bound on how long show() will wait for the DMA to complete.
 * A real frame is ~3 ms, so this only ever fires on a fault. */
#define WS281X_SHOW_TIMEOUT_MS  100u
